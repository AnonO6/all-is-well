...
export function BottomNav() {
  ...
  return (
    <nav
      className="fixed bottom-4 left-1/2 z-50 w-[calc(100%-2rem)] max-w-md -translate-x-1/2 rounded-full border border-white/70 bg-white/90 px-2 py-2 shadow-lg backdrop-blur-md"
